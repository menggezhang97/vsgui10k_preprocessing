...
def freeze_backbone_if_needed(model, freeze_backbone: bool):
...
def main():
    config_path = "baseline/configs/patch_baseline_quick_v1.json"
    ...
    freeze_backbone_if_needed(model, cfg.get("freeze_backbone", False))
